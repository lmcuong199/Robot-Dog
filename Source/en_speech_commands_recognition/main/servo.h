...
#define SERVO_MIN_US   500 // 0 degree
#define SERVO_MAX_US   2500 // 180 degree
#define SERVO_FREQ_HZ  50

// Neutral and movement positions (degrees)
#define SERVO_NEUTRAL  90 // straight down
#define SERVO_FORWARD  60   // FL, BR (swing FL and BR legs forward)
